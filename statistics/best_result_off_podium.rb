  ...
  def query
    <<-SQL
      SELECT
        ...
        CONCAT('[', competition.cell_name, '](https://www.worldcubeassociation.org/competitions/', competition.id, '/results/all#e', IrishResults.event_id, '_', round_type_id, ')') podium_link,
        pos place
      FROM IrishResults
